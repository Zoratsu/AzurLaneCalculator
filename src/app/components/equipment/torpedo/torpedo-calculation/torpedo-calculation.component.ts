...
@Component({
  selector: 'app-torpedo-calculation',
  templateUrl: './torpedo-calculation.component.html',
  styleUrls: ['./torpedo-calculation.component.scss'],
})
export class TorpedoCalculationComponent implements OnInit, OnDestroy {
