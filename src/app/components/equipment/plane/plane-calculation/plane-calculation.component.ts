...
@Component({
  selector: 'app-plane-calculation',
  templateUrl: './plane-calculation.component.html',
  styleUrls: ['./plane-calculation.component.scss'],
})
export class PlaneCalculationComponent implements OnInit, OnDestroy {
